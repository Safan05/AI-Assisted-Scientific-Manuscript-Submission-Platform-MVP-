"""
app/services/docgen/formatters/mia_formatter.py

Medical Image Analysis (Elsevier) journal formatter.
"""
...
class MIAFormatter(BaseFormatter):
    """Formatter for the Medical Image Analysis template (slug: 'medical-image-analysis')."""
    ...
    def build_title_page(self, doc: Document, ir: ManuscriptIR, layout: dict) -> None:
        ...
        if ir.corresponding_author:
            ...
            doc.add_paragraph(f"Corresponding author: {ca.full_name} ({ca.email})")
